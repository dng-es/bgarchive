 ...
 jQuery.fn.dacolorpicker = function(options) {
        ...
        this.each(function(){
                ...
                function showPalette(e){
                        var posx, posy;
                        $(".dacolor-picker").hide();
                        posx = (configuration.imageShow ? (daPickerImg.offset().left + daPickerImg.outerWidth( true )) : (e_trigger.offset().left + e_trigger.outerWidth( true )))+10;
                        posy = daPickerImg.offset().top;                
